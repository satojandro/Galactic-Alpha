...
function dmf(T) {
  ...
  var f = _base["default"].horner(T, 93.272095 * D2R, 483202.0175233 * D2R, -0.0036539 * D2R, -D2R / 3526000, D2R / 863310000);
...
function position(jde) {
  ...
  var l_ = _base["default"].horner(T, 218.3164477 * D2R, 481267.88123421 * D2R, -0.0015786 * D2R, D2R / 538841, -D2R / 65194000);
  ...
  var e = _base["default"].horner(T, 1, -0.002516, -0.0000074);
  ...
  ta.forEach(function (r) {
    var _base$sincos = _base["default"].sincos(d * r.d + m * r.m + m_ * r.m_ + f * r.f),
  ...
  var lon = _base["default"].pmod(l_, 2 * Math.PI) + Σl * 1e-6 * D2R;
  var lat = Σb * 1e-6 * D2R;
...
var ta = function () {
  ...
  return ta.map(function (row) {
    var o = {};
    var vals = ['d', 'm', 'm_', 'f', 'Σl', 'Σr'];
    vals.forEach(function (D2R, i) {
      o[D2R] = row[i];
    });
    return o;
  });
...
function node(jde) {
  return _base["default"].pmod(_base["default"].horner(_base["default"].J2000Century(jde), 125.0445479 * D2R, -1934.1362891 * D2R, 0.0020754 * D2R, D2R / 467441, -D2R / 60616000), 2 * Math.PI);
}
/**
...
function perigee(jde) {
  return _base["default"].pmod(_base["default"].horner(_base["default"].J2000Century(jde), 83.3532465 * D2R, 4069.0137287 * D2R, -0.01032 * D2R, -D2R / 80053, D2R / 18999000), 2 * Math.PI);
}
/**
...
function trueNode(jde) {
  var _dmf3 = dmf(_base["default"].J2000Century(jde)),
  ...
  return node(jde) + -1.4979 * D2R * sin(2 * (d - f)) + -0.15 * D2R * sin(m) + -0.1226 * D2R * sin(2 * d) + 0.1176 * D2R * sin(2 * f) + -0.0801 * D2R * sin(2 * (m_ - f));
}
