...
export var meanLunarMonth = 29.530588861; // (49.1) p. 349
...
var Mp = /*#__PURE__*/function () {
  function Mp(y, q) {
    ...
    this.M = base.horner(T, 2.5534 * D2R, 29.1053567 * D2R / ck, -0.0000014 * D2R, -0.00000011 * D2R);
    this.M_ = base.horner(T, 201.5643 * D2R, 385.81693528 * D2R / ck, 0.0107582 * D2R, 0.00001238 * D2R, -0.000000058 * D2R);
    this.F = base.horner(T, 160.7108 * D2R, 390.67050284 * D2R / ck, -0.0016118 * D2R, -0.00000227 * D2R, 0.000000011 * D2R);
    this.Ω = base.horner(T, 124.7746 * D2R, -1.56375588 * D2R / ck, 0.0020672 * D2R, 0.00000215 * D2R);
  ...
  var _proto = Mp.prototype;

  _proto.nfc = function nfc(c) {
    var M = this.M,
        M_ = this.M_,
        E = this.E,
        F = this.F,
